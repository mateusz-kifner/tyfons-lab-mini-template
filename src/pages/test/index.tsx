...
import TestLiveForm from "@/components/test/live-form/test-virtual-form";
...
const TestColor = dynamic(
  () => import("@/components/test/live-form/test-color"),
  { ssr: false },
);

const TestDate = dynamic(
  () => import("@/components/test/live-form/test-date"),
  { ssr: false },
);
const TestDatetime = dynamic(
  () => import("@/components/test/live-form/test-datetime"),
  { ssr: false },
);
const TestDebugInfo = dynamic(
  () => import("@/components/test/live-form/test-debug-info"),
  { ssr: false },
);
const TestJSON = dynamic(
  () => import("@/components/test/live-form/test-json"),
  { ssr: false },
);
const TestSelect = dynamic(
  () => import("@/components/test/live-form/test-select"),
  { ssr: false },
);
const TestShortText = dynamic(
  () => import("@/components/test/live-form/test-short-text"),
  { ssr: false },
);
const TestSwitch = dynamic(
  () => import("@/components/test/live-form/test-switch"),
  { ssr: false },
);
const TestText = dynamic(
  () => import("@/components/test/live-form/test-text"),
  { ssr: false },
);
